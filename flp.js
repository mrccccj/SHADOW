...
!(async () => {
    ...
    for (let i = 0; i < cookiesArr.length; i++) {
        if (cookiesArr[i]) {
            ...
            authorCodeList = [
                'ccce4aacdc65412c9a9878a5d7480603',
            ]
            $.bean = 0;
            ...
            if ($.activityContent) {
                if ($.activityContent.canJoin) {
                    ...
                    if (!$.activityContent.openCard) {
                        ...
                        await bindWithVender({ "venderId": "1000003691", "shopId": "1000003691", "bindByVerifyCodeFlag": 1, "registerExtend": {}, "writeChildFlag": 0, "activityId": 3282318, "channel": 401 }, 100000000000085)
                    }
                    await $.wait(2000)
