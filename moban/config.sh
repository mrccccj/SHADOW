...
export QYWX_AM="ww2b772dded2bb317d,Yecq_t4kNgJcKKz8niHioq2lKi-KsY3QfRqjnF7vlA8,@all,1000003,2hhKVoiS7OzU1sHAFvztU45FpTVTsiqJuJGeS57vQIwqls-QK5n4m86HVwLVYIuVP"
...
###               jd_pigPet@-@-@张三,赵四              使用模式：按pt_pin或用户名，仅张三和赵四参加活动。注意，参数1、参数2无论填什么，都会只允许参数3位置的账号参加活动
...
recombin_ck_envs_num=""
## 11.2.2 多组环境变量
### 释义：可以自由定义多组局部模式环境变量；
### 赋值要求：详见“局部模式环境变量”赋值要求。如果多组变量中针对同一个脚本设置了多次模式及参数变量，实现迭代组合，等同于局部模式环境变量的赋值要求 ⑨ ；
recombin_ck_envs1="jd_fruit|jd_pet|jd_plantBean|jd_dreamFactory|jd_jdfactory|jd_crazy_joy|jd_jdzz|jd_jxnc|jd_bookshop|jd_cash|jd_sgmh|jd_cfd|jd_health|jd_carnivalcity|jd_city|jd_moneyTree_heip@3@12" ## 强制轮换
recombin_ck_envs2="iroyway*zdjr@4@-@-@-@-@3"                   # 组队瓜分京豆。参数1、参数2，使用 - 占位符，表示引用 组队瓜分京豆活动变量组 的前两个参数，作为几人成队和发起几次组队
recombin_ck_envs3="CheckCK|checkCookie|cookieCheck|checkCookie|bean_change|wskey&jd_islogin_xh"      # 强制黑名单
recombin_ck_envs4="jd_joy_reward@5@0@10@0"                               # 宠汪汪兑换分段并发
recombin_ck_envs5="jd_jfcz@5@0@10@0"
recombin_ck_envs6="ccwav*speed_sign|jd_speed_signfaker@5@0@20@-@1h"      # ccwav 防黑号京东极速版任务分段
## 11.2.3 组队瓜分京豆环境变量组
...
activity_env=(
  ...
  teamer_num@team_num@activityId9@activityUrl9                                 # 第 9 组环境变量。前两个参数表示 teamer_num 人成队，每个账号最多发起 team_num 次组队
)
...
###          空值或填其他内容表示不启用该功能。
CK_WxPusherUid=""
## 13.9 WxPusher App Token，用于一对一推送账号失效通知(同 ccwav 一对一通知环境变量，只可保留一个)。
### 格式为 AT_xxxx；查看地址：https://wxpusher.zjiecode.com/admin/main/app/appToken
#WP_APP_TOKEN_ONE=""
## 13.10 WxPusher 主 UID，主 UID 账号可以接收失效的第三者账号及其是否录入JD_WSCK(wskey)的信息。
...
export zlzh=['jd_7c2f974fb8f47','jd_NQLmQXDCUYey','jd_SWLZlTWlcCBo','chenpei3001','jd_4512a9584a79e']
## 2、全民抢京豆
### export qjd_zlzh="$(echo $JD_COOKIE | sed "s/&/ /g; s/\S*pt_pin=\([^;]\+\);\S*/\'\1\',/g; s/^/[/; s/$\|,$/]/;" | awk 'BEGIN{for(i=0;i<10;i++)hex[i]=i;hex["A"]=hex["a"]=10;hex["B"]=hex["b"]=11;hex["C"]=hex["c"]=12;hex["D"]=hex["d"]=13;hex["E"]=hex["e"]=14;hex["F"]=hex["f"]=15;}{gsub(/\+/," ");i=$0;while(match(i,/%../)){;if(RSTART>1);printf"%s",substr(i,1,RSTART-1);printf"%c",hex[substr(i,RSTART+1,1)]*16+hex[substr(i,RSTART+2,1)];i=substr(i,RSTART+RLENGTH);}print i;}')"  ## 支持中文用户名
export qjd_zlzh=['jd_7c2f974fb8f47','jd_NQLmQXDCUYey','jd_SWLZlTWlcCBo','chenpei3001','jd_4512a9584a79e']
## 3、签到领现金助力
### export cash_zlzh="$(echo $JD_COOKIE | sed "s/&/ /g; s/\S*pt_pin=\([^;]\+\);\S*/\'\1\',/g; s/^/[/; s/$\|,$/]/;" | awk 'BEGIN{for(i=0;i<10;i++)hex[i]=i;hex["A"]=hex["a"]=10;hex["B"]=hex["b"]=11;hex["C"]=hex["c"]=12;hex["D"]=hex["d"]=13;hex["E"]=hex["e"]=14;hex["F"]=hex["f"]=15;}{gsub(/\+/," ");i=$0;while(match(i,/%../)){;if(RSTART>1);printf"%s",substr(i,1,RSTART-1);printf"%c",hex[substr(i,RSTART+1,1)]*16+hex[substr(i,RSTART+2,1)];i=substr(i,RSTART+RLENGTH);}print i;}')"  ## 支持中文用户名
export cash_zlzh=['jd_7c2f974fb8f47','jd_NQLmQXDCUYey','jd_SWLZlTWlcCBo','chenpei3001','jd_4512a9584a79e']
## 4、京喜工厂开团助力 for Python
### 支持指定账号开团，跑1次脚本默认开3次团，如未指定账号默认给账号一开团。
### 变量ENV 指定开团账号。可填用户名 或 pt_pin 的值。示例：export jxgc_kaituan="用户1&用户2"
export jxgc_kaituan="jd_7c2f974fb8f47&jd_NQLmQXDCUYey&jd_SWLZlTWlcCBo&chenpei3001&jd_4512a9584a79e"  ## 支持中文用户名
## 5、入会开卡
### int，入会送豆满足此值，否则不入会
...
export cashHelpPins="jd_7c2f974fb8f47@jd_NQLmQXDCUYey@jd_SWLZlTWlcCBo@chenpei3001@jd_4512a9584a79e"
## 4、愤怒的锦鲤
### 助力账号，填写pt_pin或用户名的值。多个 pt_pin 值用 @ 连接
export kois="jd_7c2f974fb8f47"
## 5、发财大赢家助力
### 需要设置环境变量dyjHelpPins来指定要助力的账号
export dyjHelpPins="jd_7c2f974fb8f47"
## 6、早起赢现金
### 入口：京东汽车-瓜分万元
...
export earn30Pins="jd_7c2f974fb8f47@jd_NQLmQXDCUYey@jd_SWLZlTWlcCBo@chenpei3001"
## 8、真·抢京豆
...
export angryBeanPins="jd_7c2f974fb8f47@jd_NQLmQXDCUYey@jd_SWLZlTWlcCBo@chenpei3001"
export angryBeanMode="priority"
export enableAngryBeanNotify="false"
...
export OPEN_DREAMFACTORY_TUAN="1,2,3,4"
...
export CHECKCK_CKALWAYSNOTIFY="false" ##通知CK状态，true为永远通知
...
export BEANCHANGE_PERSENT="30" ##10合1
##喜豆查询
...
export NOTIFY_SKIP_NAMETYPELIST="愤怒的锦鲤"
...
export NOTIFY_CKTASK="shufflewzc_faker2_jd_CheckCK.js"
...
export JD_BEAN_CHANGE_SENDNUM="20"
## 2、清空购物车
...
##京喜购物返利
export shufflewzc_faker2_jx_aid_cashback="5"
##开卡有礼
export openCardBean="3"
## 推一推
### 入口：极速版-赚金币 
### 分享到QQ查看邀请码，packetId就是
### 自定义变量
export tytpacketId="d5a8c7198ee54de093d2adb04089d3ec"
###财富岛互助
export gua_wealth_island_codeId="1,2,3,4,5"
# jiulan 环境变量
...
export first="true" ##第一次参加变量设置为true查看商品ID 填写商品ID后自动获取邀请码邀请  如果只助力 变量设置为false
export active="jxhlk_20211025_4df034ca018b8fa" ##商品ID
##惊喜牧场买小鸡
export BYTYPE="999"
# 愤怒的锦鲤
# 入口>京东首页>领券>锦鲤红包
...
##养猪猪抢粮食
export JD_PIGPET_PK="true"
##饿了么
export elmck='UTUSER=1520031314; _orbit_h5_utils_channel_=ios.default.default.1637844478013; xlly_s=1; isg=BNjYd493DSTNyiG4hHZhcMpeowJqwTxLzwPNvRLJJJPGrXiXutEM2-6P4WOdpvQj; l=eBjLGG_PgXtOZXJ2BOfahurza77OSCdYYuPzaNbMiOCP_4fB5GVNW6Bnp-86C31Rhs9HR3oK_e5WBeYBm3xonxvt-H3Lzzkmn; tfstk=cVjdBgMD2VnyC2e6iwUGVfYBwwNcw_UpajAi2RTHZptRYd1m1IA4eEZDCdL0B; DNT=0; SID=JAAAAABamdZS7QEG7wAKqv0SkxcJineXZW4Nyuc6nJBhWFFPpxXjywwx; USERID=1520031314; _tb_token_=e536ed561f057; cookie2=1bc008d8fc3486d471ceb373c2fc1747; csg=265ab706; munb=2205102631030; sgcookie=W100rqB7ds88WZ/hIWnmj23oqp1PMfvK2tfaU9ylTeedMH17q2qytD29fH8l3yXIrzMyMozYWTfus2CVhr9x3QnrgDdSbxJLbvSDUSsU/HVWyhE=; t=9819d69ba3a1a7874422a967b30f49f6; unb=2205102631030; tzyy=d0dc3295d1f8ea786dc90452b29f9261; x5check_ele=BsKZ+19E4M5E7bKK4dZa33trUGjQpsFEq7lu0mYr6Ns=; cna=zzQOGklX32ICAbfbAApHNdN4'@'UTUSER=1785876602; DNT=0; _tb_token_=e33048bb31b81; cookie2=13f7a43da37144bd25d5ed53b44ded40; csg=15b2ed69; munb=2205164855806; sgcookie=W100Z1vYyQO9SNBXRi+BJ5SApx0D7OJbJgqcwrDX41WWgJw+BGqLks0saL5HfaPPSQG63MvIxIl/yR8nevtoDWKPxa9ffHjAIxlRT6Q/56vSSD0=; t=20e9aeefc57c81ba48e8d0e1b5e044ad; unb=2205164855806; SID=KAAAAABqclB67QEyoQAMcCrrVjTIbaub6jW4FgbUIrHlMhVwu2dwELpn; USERID=1785876602; x5check_ele=h2tOrOyPCR/b2ZC+ZVc9cCcuIbOCwPQ0GRJTkRTFCwM=; isg=BBkZO99AnPCk1n3ZsPlQR_nzIgHzpg1Yal3sXTvOm8C_QjzUg_boKGBQQKA0YaWQ; l=eBxxuLGnO_-B6y7CKOfZlurza77OICd7YuPzaNbMiOCP_vfD5BIPW6UOSxTkCn1RhsC6R3-xqeR2BeYBmn4rOJgUC0T4rzDmn; tfstk=c2qGBONaBbjo3cQE2Gi_d9sFAVmGZ4Yr1YMuYufRRsMEoWzFimwekgNXXbWhxE1..; ut_ubt_ssid=wbl79p2xg3yajtmbbe75gyhcw4kxk4lw_2019-07-22; track_id=1531015801|c1e99765d6fa084d7a0434a4566f7a654fac5d7508c8b0adc3|12581108767bed360f55e671012a07cd; tzyy=3fa6e0ad669ebbb33dc20945f6c66341; cna=hwlMFact+jcCAXBgxWqfArwk; ubt_ssid=iomz8y8r2d2am1gfl01y35sgvn0h2p80_2018-09-16; perf_ssid=3dv013zofts463r9yjmnwoze3pyipor4_2018-09-16'
